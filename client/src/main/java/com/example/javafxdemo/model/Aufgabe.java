...
//    public Aufgabe(String name, LocalDate startDate, LocalDate endDate, User author, int groupCount, AufgabeStatus status) {
//        this.name = name;
...
//    }
    ...
    public Aufgabe(Long id, String name, LocalDate startDate, LocalDate endDate, User author, int groupCount, AufgabeStatus status) {
        this.id = id;
        this.name = name;
        this.startDate = startDate;
        this.endDate = endDate;
    ...
    public Aufgabe(String name, LocalDate startDate, LocalDate endDate, User author, int groupCount, int maxNumber, String aufgabenStellung, AufgabeStatus status, List<Gruppe> gruppen, Boolean freieEinschreibung) {
        this.name = name;
        this.startDate = startDate;
        this.endDate = endDate;
        this.author = author;
